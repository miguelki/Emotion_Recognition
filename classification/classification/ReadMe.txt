========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet classification
========================================================================

AppWizard a créé cette application classification pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application classification.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé classification.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
