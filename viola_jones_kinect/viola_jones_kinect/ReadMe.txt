========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet viola_jones_kinect
========================================================================

AppWizard a créé cette application viola_jones_kinect pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application viola_jones_kinect.


viola_jones_kinect.vcxproj
...
viola_jones_kinect.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé viola_jones_kinect.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
