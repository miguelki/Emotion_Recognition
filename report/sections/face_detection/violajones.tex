...
\begin{figure}[!h]
\begin{center}
\noindent \includegraphics[scale=0.4]{figures/integral_image_description} 
\newline
...
\begin{figure}[!h]
\begin{center}
\noindent \includegraphics[scale=0.5]{figures/integral_image_four_array} 
\newline
...
\begin{figure}[!h]
\begin{center}
\noindent \includegraphics[scale=0.5]{figures/haar_feature_adaboost} 
\newline
