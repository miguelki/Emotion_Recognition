...
\newline
\caption{Example eye occlusion in the AR Face database \cite{ARFACE}}
...
\newline
\caption{Example of face occlusion in the AR Face database \cite{ARFACE}}
...
\newline
\caption{Example of different lighting conditions (from left to right: dark to bright) in the AR Face database \cite{ARFACE}}
